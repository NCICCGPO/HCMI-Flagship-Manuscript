...
Sequencing reads for the tumor and normal samples are aligned to the reference genome using BWA-MEM2 (v2.2.1) ([1](#1)).
...
GATK (v4.2.5.0) ([3](#3)) FixMateInformation is run to verify and fix mate-pair information, followed by Novosort 
...
consists of MuTect2 (GATK 4.2.5.0) ([6](#6))), Strelka2 (2.9.3) ([7](#7)) and Lancet (1.0.7) ([8](#8))] for calling
...
(MAF) of 1% or higher in either 1000Genomes (phase 3) or gnomAD non-cancer sammples (exomes r2.1.1 and genomes v3.1.2)([19](#19)), and SVs that
...
#### SNVs and Indels
Somatic and germline SNVs/Indels are annotated with Ensembl Variant Effect Predictor (v97) ([20](#20)) as well as databases such as COSMIC (v98)
([21](#21)), 1000Genomes (Phase3) ([22](#22)) , ClinVar (201904) ([23](#23)), Polyphen2 (v2.2.2) ([24](#24)), SIFT (v5.2.2) 
([25](#25)), FATHMM (v2.1) ([26](#26)), gnomAD (exomes r2.1.1 and genomes v3.1.2) and dbSNP (v150) ([27](#27)) using Variant Effect Predictor.
...
(v4.2.5.0), which generates a single-sample GVCF. We then run GATK’s GenotypeGVCF to
...
<a name="1"></a>
1. Md,V., Misra,S., Li,H.,  Aluru,S. (2019) Efficient Architecture-Aware Acceleration of BWA-MEM for Multicore Systems. IEEE Parallel and Distributed Processing Symposium (IPDPS), 10.1109/IPDPS.2019.00041
<a name="1"></a>
